...
const RoleBasedStats = {
  ...
  CUSTOMER: [
    { title: 'Active Bookings', icon: <BookingIcon />, color: 'primary', path: '/dashboard/spending' },
    { title: 'Total Spent', icon: <MoneyIcon />, color: 'info', path: '/dashboard/spending' },
    { title: 'Properties Viewed', icon: <ApartmentIcon />, color: 'success', path: '/dashboard/properties' },
